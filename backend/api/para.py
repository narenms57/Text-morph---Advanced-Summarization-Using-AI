...
def generate_paraphrase(text, tokenizer, model,max_length=100, min_length=20, length_penalty=1.0, num_beams=4):
    text_str = str(text)
...
def paraphrase_long_text(text,tokenizer, model, chunk_token_limit=512, paraphrase_params=None):
